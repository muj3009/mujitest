        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <!-- <div class="item">
                            <img src="/hi/item1.jpg" class="img-responsive" alt="">
                        </div>  -->
                        <!-- /Users/Muj/Desktop/FINALPROJECTNEW/SpringBoot1/src/main/resources/static/uploadedImages/p11249988@gmail.com/item1.jpg -->
                        <div class="item">
                            <img src="/public/img/main-slider8.jpg" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/public/img/main-slider5.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/public/img/main-slider6.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/public/img/main-slider1.jpg" alt="">
                        </div>
                        <div class="item">
                    ...
                    <div class="product-slider">
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail">Estee Lauder (Perfume)</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail">Jadore Dior</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail">Perfumes</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail">J'adore Dior</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>

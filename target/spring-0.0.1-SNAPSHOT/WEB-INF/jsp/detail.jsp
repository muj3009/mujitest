 ...
 _________________________________________________________ -->
                    ...
                    <div class="banner">
                        <a href="#">
                            <img src="public/img/banner.jpg" alt="sales 2014" class="img-responsive">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        <div class="col-sm-6">
                            <div id="mainImage">
                                <img src="public/img/detailbig1.jpg" alt="" class="img-responsive">
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <h1 class="text-center">Estee Lauder (Perfume)</h1>
                            ...
                            <div class="row" id="thumbs">
                                <div class="col-xs-4">
                                    <a href="public/img/detailbig1.jpg" class="thumb">
                                        <img src="public/img/detailsquare.jpg" alt="" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="public/img/detailsquare2.jpg" class="thumb">
                                        <img src="public/img/detailsquare2.jpg" alt="" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="public/img/detailbig3.jpg" class="thumb">
                                        <img src="public/img/detailsquare3.jpg" alt="" class="img-responsive">
                                    </a>
                                </div>
                            </div>
                        </div>
